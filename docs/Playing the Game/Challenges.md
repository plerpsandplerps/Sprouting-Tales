...
1. The Guide chooses the [Difficulty](docs/Playing%20the%20Game/Challenges#difficulty) and sets that many World Tree Cards in a facedown pile for the Challenge. 
...
2. Any Player whose Adventurer is facing the Challenge may choose to increase the Difficulty of the Challenge by one to [Discover](docs/Playing%20the%20Game/Challenges#discover). If they do, that Player adds an additional facedown World Tree Card to the facedown pile for the Challenge.
3. The Guide turns all World Tree Cards in the facedown pile faceup.
4. Calculate an [Adventurer's Score](docs/Playing%20the%20Game/Challenges#adventurer-score). 
...
7. Calculate the [Challenge's Score](docs/Playing%20the%20Game/Challenges#challenge-score).
...
9. Resolve any remaining [Boons or Bane World Tree Cards](docs/Playing%20the%20Game/Challenges.md#special-world-tree-cards). 

## Difficulty

Challenges have a **Difficulty**, a number chosen by the [Guide](Basics#Guide) between one and ten. Once the Difficulty is chosen by the Guide, the Guide places that many [World Tree Cards](_drafts/WorldTreeCards) in a facedown pile. 
...
If multiple Players decided to Discover, then deal [Order Cards](docs/Playing%20the%20Game/OrderCards) to decide the order in which Players pick World Tree Cards to add to their Branches. 
...
- Lose a [Doubt](_drafts/ConsequenceCards#doubt) or [Injury](_drafts/ConsequenceCards#injury) card; 
- The Challenge takes less time to overcome;
- The cover opponents are hiding behind is destroyed; or
- The Adventurers gain a [Supply Card](_drafts/Items#supply-cards). 
